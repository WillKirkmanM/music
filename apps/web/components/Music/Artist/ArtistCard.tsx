...
export default function ArtistCard({ artist, showFollowers = true }: ArtistCardProps) {
      ...
      <div className="w-44 h-64 flex items-center justify-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            {showFollowers && (
              <p className="font-bold text-white overflow-hidden overflow-ellipsis whitespace-nowrap">{formatFollowers(artist.followers)} Followers</p>
            )}
          </div>
        </div>
      </div>
